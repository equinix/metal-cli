...
Download the appropriate Packet CLI package, build and install them. Type the following in your terminal:
...
Download the appropriate Packet CLI binaries for your platform to the desired location,`chmod` it and rename it to `packet`. 
