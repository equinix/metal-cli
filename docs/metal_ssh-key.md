...
SSH key operations for managing SSH keys on user accounts and projects. Keys added to an account or project are added to servers at provision. Documentation is available on https://docs.equinix.com/metal/identity-access-management/ssh-keys/.
