...
A Metal Gateway provides a single IPv4 address as a gateway for a subnet. For more information, visit https://docs.equinix.com/metal/networking/metal-gateway/.
